    ...
    <div class="p-8 max-w-7xl mx-auto space-y-8">
        ...
        <div x-show="open" x-transition
            ...
            <div @click.away="open = false" class="bg-white rounded-lg shadow-lg w-full max-w-lg p-6">
                <h2 class="text-xl font-semibold text-gray-800 mb-4">Bulk Upload</h2>
                ...
                <form wire:submit="save" enctype="multipart/form-data">
                    <div>
                        ...
                        @error('excelFile') <span>{{ $message }}</span> @enderror
                    </div>
                    {{--
                    <div>
                        ...
                        <input type="file"
                            class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-green-500 focus:border-green-500 sm:text-sm"
                            wire:model="zipFile" accept="application/zip" />
                        @error('zipFile') <span>{{ $message }}</span> @enderror
                    </div> --}}
