...
namespace App\Models {
     ...
     * @property mixed $cert_id
     * @property string $name
     * @property string $id
     * @property-read \App\Models\Tranning $tranning
     ...
     * @method static \Illuminate\Database\Eloquent\Builder<Student>|Student whereCertId($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Student>|Student whereCertificate($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Student>|Student whereEmail($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Student>|Student whereTrainingId($value)
     ...
     * @method static \Illuminate\Database\Eloquent\Builder<Tranning>|Tranning whereId($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Tranning>|Tranning whereTitle($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Tranning>|Tranning whereInstructor($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Tranning>|Tranning whereMetaData($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Tranning>|Tranning whereDate($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Tranning>|Tranning whereCreatedAt($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Tranning>|Tranning whereUpdatedAt($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Tranning>|Tranning newModelQuery()
     * @method static \Illuminate\Database\Eloquent\Builder<Tranning>|Tranning newQuery()
     * @method static \Illuminate\Database\Eloquent\Builder<Tranning>|Tranning query()
     * @method static mixed select($columns)
     * @method static mixed selectSub($query, $as)
     * @method static mixed selectRaw($expression, array $bindings)
     * @method static mixed fromSub($query, $as)
     ...
     * @mixin \Illuminate\Database\Query\Builder
     */
    class Tranning extends \Illuminate\Database\Eloquent\Model
    {
        //
    }
